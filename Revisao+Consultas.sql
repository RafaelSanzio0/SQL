-- CONSULTA PASSANDO CAMPO A CAMPO
SELECT [CPF]
      ,[NOME]
      ,[ENDERECO 1]
      ,[ENDERECO 2]
...
-- CONSULTA PASSANDO TODOS OS CAMPOS
SELECT * FROM [TABELA DE CLIENTES]

-- CONSULTA PASSANDO ALGUNS CAMPOS
SELECT [CPF]
      ,[NOME]
    FROM [TABELA DE CLIENTES]

-- CONSULTA ALTERANDO O NOME DAS COLUNAS
SELECT [CPF] AS IDENTIFICADOR
      ,[NOME] AS CLIENTE
    FROM [TABELA DE CLIENTES]

-- CONSULTA ALTERANDO A ORDEM
 SELECT 
		  [NOME] AS CLIENTE
